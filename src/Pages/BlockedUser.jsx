...
function BlockedUser() {
    ...
    const handleUnblock = async (mailId) => {
        try{
            ...
            array1 = array1.filter(item => item != mailId)
            const data1 = {...user,blockedUsers:array1}
                ...
                <MDBTableBody>
                    {
                        ...
                        .map((item,index)=>(
                            <tr key={index} className='border-bottom border-info'>
                                ...
                                <td>
                                    <button className='btn btn-light text-success m-1' onClick={()=>handleUnblock(item?.email)}><i className="fa-solid fa-ban"></i></button>
                                </td>
                            </tr>
                        ))
                        :<></>
